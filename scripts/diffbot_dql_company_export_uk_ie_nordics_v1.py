...
BASE_NAME = os.getenv("DIFFBOT_OUTPUT_BASENAME", "uk_ie_nordics_industrial_ai_integrators_v1")
...
has:homepageUri
or(
  location.country.name:or("United Kingdom","Ireland","Norway","Finland","Sweden","Denmark","Iceland","Estonia","Latvia","Lithuania"),
  locations.country.name:or("United Kingdom","Ireland","Norway","Finland","Sweden","Denmark","Iceland","Estonia","Latvia","Lithuania")
)
or(
  description:or("machine vision","computer vision","visual inspection","optical inspection","automated optical inspection","inline inspection","quality inspection","defect detection","image processing","robot guidance","vision-guided robotics","deep learning inspection","industrial ai consulting","ai consulting","machine vision consulting","computer vision consulting","process automation with ai","industrial analytics","predictive quality"),
  allDescriptions:or("machine vision","computer vision","visual inspection","optical inspection","automated optical inspection","inline inspection","quality inspection","defect detection","image processing","robot guidance","vision-guided robotics","deep learning inspection","industrial ai consulting","ai consulting","machine vision consulting","computer vision consulting","process automation with ai","industrial analytics","predictive quality")
)
or(
  description:or("system integrator","system integration","turnkey","customer-specific","custom solution","engineering services","consulting","implementation","delivery","project delivery","solution delivery","integration services","commissioning","retrofit","quality control","process automation","workflow automation","special purpose machine","machine builder","oem automation","industrial software"),
  allDescriptions:or("system integrator","system integration","turnkey","customer-specific","custom solution","engineering services","consulting","implementation","delivery","project delivery","solution delivery","integration services","commissioning","retrofit","quality control","process automation","workflow automation","special purpose machine","machine builder","oem automation","industrial software")
)
or(
  description:or("industrial","manufacturing","factory","production","inspection","quality","automation","warehouse automation","robotics","packaging","pharma","food processing","automotive"),
  allDescriptions:or("industrial","manufacturing","factory","production","inspection","quality","automation","warehouse automation","robotics","packaging","pharma","food processing","automotive")
)
not(
  or(
    description:or("industrial cameras","camera manufacturer","sensor manufacturer","barcode readers","laser markers","digital microscopes","measurement systems","distributor","reseller","wholesale","catalog products","technical education","training provider","recruiting","video surveillance","security cameras","traffic enforcement","marketing agency","face recognition","biometrics","document scanners","document capture","industrial pc","metering pumps","consumer electronics","semiconductor products","product platform"),
    allDescriptions:or("industrial cameras","camera manufacturer","sensor manufacturer","barcode readers","laser markers","digital microscopes","measurement systems","distributor","reseller","wholesale","catalog products","technical education","training provider","recruiting","video surveillance","security cameras","traffic enforcement","marketing agency","face recognition","biometrics","document scanners","document capture","industrial pc","metering pumps","consumer electronics","semiconductor products","product platform")
  )
)"""
