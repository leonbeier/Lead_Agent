  ...
  private localizeTemplate(template: ReturnType<typeof getTemplateForCategory>, language: "de" | "en") {
    ...
    const englishVariants: Record<string, { subject: string; emailBody: string; linkedInConnectionRequest: string; linkedInMessage: string; phoneScript: string }> = {
      integrator_vision_industrial_ai_template: {
        subject: "Ship Vision AI projects faster with less optimization effort",
        emailBody: "Hello Mr./Ms. [Name],\n\nI saw that you implement Vision AI projects for industrial customers.\n\nA common bottleneck: model selection, fine-tuning, and optimization for the target hardware consume a disproportionate amount of time, especially with demanding requirements like small datasets, high accuracy, or edge deployment.\n\nWe have developed a technology where the application does not need to be optimized around an existing model. Instead, a suitable AI model is automatically generated for the specific use case and available hardware.\n\nThis makes Vision AI projects significantly more predictable and faster to reach production, even with difficult datasets or limited compute.\n\nIn a joint whitepaper with chip manufacturer Altera we showed that generated models can run over 1000x faster while producing 24x fewer errors than conventional approaches.\n\nIf this is relevant for current or upcoming projects, I would be happy to have a short exchange.\n\nBest regards,\n[Your Name]",
        linkedInConnectionRequest: "I saw you deliver Vision AI projects. We have built something that cuts model-optimization effort significantly — happy to share.",
        linkedInMessage: "Hi [Name], thanks for connecting.\n\nI saw that you implement Vision AI projects. A common bottleneck: model selection, fine-tuning, and hardware optimization bind a lot of time, even when the use case is clear.\n\nWe have developed a technology where a suitable AI model is automatically generated for the specific use case and target hardware. This makes Vision AI projects significantly faster to test and bring to production.\n\nDo you have current projects where model optimization or edge deployment is consuming more time than expected?",
        phoneScript: "Hello Mr./Ms. [Name], this is [Your Name] from ONE WARE. Quick question: in your current Vision AI projects, how much time goes into model selection, fine-tuning, and hardware optimization? We automate exactly that part. Would that be worth a short conversation?"
      },
