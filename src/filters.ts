...
export const defaultApolloFilters: ApolloOrganizationFilter[] = [
  {
    ...
    industries: ["Industrial Automation", "System Integration", "Information Technology", "Industrial Software"],
    keywords: ["system integrator", "industrial automation", "industrial software", "embedded systems", "automation"],
    locations: ["Germany"],
  ...
  },
  {
    ...
    industries: ["Information Technology", "Industrial Automation", "Computer Software"],
    keywords: ["artificial intelligence", "machine learning", "computer vision", "software development", "integration"],
    locations: ["Germany"],
  ...
  },
  {
    ...
    keywords: ["quality control", "inspection", "process automation", "production line", "manufacturing"],
    locations: ["Germany"],
  ...
  },
  {
    ...
    keywords: ["machine builder", "robotics", "inspection", "automation", "special machinery"],
    locations: ["Germany"],
